...
export const TranscriptCard: React.FC<TranscriptCardProps> = ({
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      onClick={onClick}
      className="bg-gray-800 border border-gray-700 rounded-lg p-6 hover:bg-gray-750 transition-all duration-200 cursor-pointer group max-w-full overflow-hidden"
    >
